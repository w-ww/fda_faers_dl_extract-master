...
##
base_path = "C:/SQL/FDA_FAERS/Python_DL/fda_faers_dl_extract/TEST/"
...
for k in range(0, len(download_urls)):
    ...
    os.makedirs("C:/SQL/FDA_FAERS/Python_DL/fda_faers_dl_extract/TEST/TEMP")
    with zipfile.ZipFile(filename) as zip:
        zip.extractall("C:/SQL/FDA_FAERS/Python_DL/fda_faers_dl_extract/TEST/TEMP")
        files = glob.iglob(os.path.join("C:/SQL/FDA_FAERS/Python_DL/fda_faers_dl_extract/TEST/TEMP/ascii", "*.txt"))
        for file in files:
            if os.path.isfile(file):
                shutil.copy2(file, "C:/SQL/FDA_FAERS/Python_DL/fda_faers_dl_extract/TEST/DATA")
    shutil.rmtree("C:/SQL/FDA_FAERS/Python_DL/fda_faers_dl_extract/TEST/TEMP/")
